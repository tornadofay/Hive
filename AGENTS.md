...
115. Tests for Hive Core contracts must explicitly include using Hive.Core; and using Xunit; alongside any additional required usings. Tests must exercise normal, invalid, boundary, cancellation, concurrency, and recovery behavior when those cases are part of the contract.
