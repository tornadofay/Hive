...
- **Phase 1 — Base Agent, Provider Platform, Management UI, and Data-Entry Pipeline (V1):** In progress. **1.1–1.13 are complete and verified.** The Hive.Core Production Polish maintenance pass is also complete and verified; **no later roadmap slice is active or authorized.** [Verification archive](verification/phase-1/index.md)
