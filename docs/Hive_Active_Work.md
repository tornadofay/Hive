...
The xUnit1031 regression was corrected by converting `Dispose_StillDisposesLifetimeAfterCurrentGraphThrows` to an async test and awaiting `InitializeAsync()`. No production code or scope changed.
